    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div id="buttonDiv" class="bg-white shadow-md rounded-lg p-6" style="margin-top: 15px;">
                ...
                <div class="flex">
                    <x-primary-button id="getInvoiceBtn" class="flex-grow mx-2 flex justify-center" onclick="getData('regex')">
                        REGEX
                    </x-primary-button>
                    <x-primary-button id="getInvoiceBtn1" class="flex-grow mx-2 flex justify-center" onclick="getData('ocr')">
                        OCR
                    </x-primary-button>
                    <x-primary-button id="getInvoiceBtn2" class="flex-grow mx-2 flex justify-center" onclick="getData('dl')">
                        DL
                    </x-primary-button>
                </div>
            </div>
            ...
            <div id="loading" class="flex items-center justify-center" style="margin-top: 100px; margin-bottom: 100px; display:none">
